            ...
            <div class="bg-gradient-to-br from-white to-gray-50   rounded-xl shadow-lg overflow-hidden border border-gray-100 ">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900 ">Informação do Projeto</h3>
                            <p class="text-sm text-gray-500 ">Detalhes sobre este projeto</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-4 bg-white  rounded-lg border border-gray-200 ">
                            <h4 class="text-lg font-medium text-gray-900  mb-4">Projeto</h4>
                        ...
                        <!-- Team Members -->
                        <div class="p-4 bg-white  rounded-lg border border-gray-200 ">
                            <h4 class="text-lg font-medium text-gray-900  mb-4">Equipa de desenvolvedores</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-indigo-100  flex items-center justify-center">
                                        <span class="text-indigo-600  font-medium">NM</span>
                                    </div>
                                    <div>
                                        <br>
                                        <p class="text-sm font-medium text-gray-900 ">Nuno Martins</p>
                                        <p class="text-sm text-gray-500 ">Student #2201775</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-white  rounded-lg border border-gray-200 ">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900 ">Prof. António Manuel de Jesus Pereira</p>
                        ...
                        <!-- Project Details -->
                        <div class="p-4 bg-white  rounded-lg border border-gray-200 ">
                            <h4 class="text-lg font-medium text-gray-900  mb-4">Detalhes do Projeto</h4>
                            <p class="text-gray-700 ">
